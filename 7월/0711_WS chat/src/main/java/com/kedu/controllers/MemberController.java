...
public class MemberController {
	...
	public String idcheck(String id) throws Exception {
		boolean result = serv.isIdExist(id);
	...
	public String login(MembersDTO dto) throws Exception {
		boolean result = serv.isMember(dto);
		if(result) {
	...
	public String signout() throws Exception {
		...
		int result = serv.deleteMember(loginId);
	...
	public String mypage(Model model) throws Exception {
		...
		MembersDTO dto = serv.selectMember(loginID);
	...
	public String mypage(String name) throws Exception {
		...
		String loginID = (String)session.getAttribute("loginID");
		serv.updateMember(name, loginID);
