    ...
    <div class="wrap">
      <form action="/board/updateBoard" method="post">
        ...
        <div id="file_box"
          ...
          "
        >
          <button type="button" id="file_list">파일첨부 목록보기</button>
        </div>

        <input type="hidden" name="seq" id="hidden_seq" value="${dto.seq}" />
        ...
        $.ajax({
          ...
          data: {seq: seq}
        	...
        	for (let file of resp) {
				let div = $("<div>");
				let anker = $("<a>");
				anker.attr("href","/file/download?sysname="+file.sysname+"&oriname="+file.oriname);
				
				anker.append(file.oriname);
				div.append(anker);
				$("#file_box").append(div);
			}
        });
